...
Слово "функція" має різноманітне значення в програмуванні. Наприклад, у світі функційного програмування "функція" має точне математичне визначення і передбачає суворий набір правил, яких потрібно дотримуватися.
...
Якщо ви попрацювали з JS вже деякий час і читали про неї, ви, безсумнівно, бачили так званий оператор "потрійна рівність" === `, який також називають оператором "суворої рівності". Це здається досить прямолінійним, так? Звичайно, "суворий" означає суворий, як у вузькому та *точному* сенсі.
...
Так само, як `==`, ці оператори будуть діяти так, ніби вони "суворі", якщо типи, що реляційно порівнюються, вже збігаються, але вони дозволять спочатку приведення типів (як правило, до чисел), якщо типи відрізняються.
