...
Можливо, вас здивує розгляд окремих .js-файлів як окремих програм, адже з точки зору користувача це одніа велика програма. Це можливо, бо виконання застосунку дозволяє цим окремим *програмам* взаємодіяти та діяти як одна програма.
