...
З іншого боку, є *природа*, на яку вам справді слід звернути увагу та зважати: *природа* того, як працює JS на мовному рівні. Є речі, які працюють добре та природно в JS, враховуючи правильну практику та підхід, і є речі, які вам насправді не варто намагатися робити.
