...
Я погоджуюсь з тим, що JS-розробники мають знати більше про типи, а також про те, як JS обходиться з перетвореннями типів. Я також згоден, що інструменти для роботи з типами можуть допомогти розробникам, за умови, що вони перед використанням інструментів здобули ті знання та використовують їх!
