...
Щоб дізнатись більше про типи та приведення типів у JS, перегляньте Книгу 4, *Типи та граматика*. Але, будь ласка, не пропускайте цю тему лише тому, що ви завжди чули, що слід використовувати `===` і не перейматися через деталі.
