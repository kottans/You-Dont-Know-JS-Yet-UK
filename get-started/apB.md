...
У цьому додатку ми розглянемо деякі вправи та запропоновані нами рішення. Ці вправи допоможуть вам *розпочати* застосовувати ідеє з цієї книги на практиці.
...
Тепер давайте потренуємось у використанні замикань (Глава 4, Опора 1).
...
Барабан вміє *тільки* відображати (`display()`) свій поточний символ слота, але ігровий автомат зазвичай показує три символи на барабані: поточний слот (`position`), один слот зверху (`position - 1`) і один слот внизу (`position + 1`). Отже, відображення ігрового автомата повинно закінчитися відображенням сітки символів ігрових автоматів 3 x 3.
